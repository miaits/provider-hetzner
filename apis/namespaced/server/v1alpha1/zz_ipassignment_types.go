...
type IPAssignmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/miaits/provider-hetzner/apis/namespaced/server/v1alpha1.IP
	FloatingIPID *float64 `json:"floatingIpId,omitempty" tf:"floating_ip_id,omitempty"`

	// Reference to a IP in server to populate floatingIpId.
	// +kubebuilder:validation:Optional
	FloatingIPIDRef *v1.NamespacedReference `json:"floatingIpIdRef,omitempty" tf:"-"`

	// Selector for a IP in server to populate floatingIpId.
	// +kubebuilder:validation:Optional
